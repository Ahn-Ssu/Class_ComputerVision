...
int main(int argc, char** argv){
    String modelConfiguration = "/Users/ahn_ssu/git/Class_ComputerVision/src/deep/yolov2-tiny.cfg";
    String modelBinary = "/Users/ahn_ssu/git/Class_ComputerVision/src/deep/yolov2-tiny.weights";

    Net net = readNetFromDarknet(modelConfiguration, modelBinary);

    VideoCapture cap("/Users/ahn_ssu/git/Class_ComputerVision/src/deep/downtown_load.mp4");
