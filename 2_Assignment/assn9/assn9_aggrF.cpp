...
int main()
{
    ...
    while (true) // Video stream iteration
    {
        ...
        else if (B_key_flag)
        {
            ...
            putText(detected_area, format("There are %d people.", person_count), Point(50, 80), FONT_HERSHEY_SIMPLEX, 1, Scalar(255, 255, 255), 4, CV_AA);
...
void fgi_call(Mat frame, int user_input){
